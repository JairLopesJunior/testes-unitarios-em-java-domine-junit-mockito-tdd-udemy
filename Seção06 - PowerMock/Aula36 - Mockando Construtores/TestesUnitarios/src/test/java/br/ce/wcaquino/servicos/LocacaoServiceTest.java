...
public class LocacaoServiceTest {
	...
	public void deveAlugarFilme() throws Exception {
		...
		error.checkThat(DataUtils.isMesmaData(locacao.getDataLocacao(), DataUtils.obterData(1, 4, 2022)), is(true));
		error.checkThat(DataUtils.isMesmaData(locacao.getDataRetorno(), DataUtils.obterData(2, 4, 2022)), is(true));
	}
